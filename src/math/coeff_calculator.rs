...
/// when we have **1st condition** at the left and **1st condition** at the right
pub mod first_first_calculator {
	...
	pub struct FirstFirstCalculator<'a, 
	...
	impl<   
					...
					FunctionType: Function<Number>,
					Number: NumberTrait,
			> FirstFirstCalculator<'a, SteppingObject, KFunctionType, QFunctionType, FunctionType, Number>
	{
			pub fn new(
					stepping: SteppingObject,
					kfunc: &'a KFunctionType,
	...
	impl<
			...
			for FirstFirstCalculator<'a, SteppingObject, KFunctionType, QFunctionType, FunctionType, Number>
	{
		fn calc_a(&self, i: usize) -> Number {
			if i == 0 {
					panic!("i == 0")
